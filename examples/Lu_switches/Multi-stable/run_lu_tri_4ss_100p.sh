...
#BSUB -o log.lu_4ss_100p
#BSUB -e err.lu_4ss_100p
#BSUB -W 100:00
...
python $exe/my_abc.py -i input_file_lu_4ss_100p.xml -o results_lu_4ss_100p -l lu_4ss_100p.log;# Rscript plot_posterior.R;
