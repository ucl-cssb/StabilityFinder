...
def central():
    ...
    if pop_indic == 0:
        ...
        os.makedirs(str(pop_fold_res_path))
    ...
    while epsilons[0] > epsilons_final[0] or epsilons[1] > epsilons_final[1] or epsilons[2] > epsilons_final[2]:
        ...
        if epsilons[0] <= epsilons_final[0] and epsilons[1] <= epsilons_final[1] and epsilons[2] <= epsilons_final[2]:
            ...
            break
    return final_weights, final_particles, final_timecourse1, final_timecourse2, pop_fold_res_path
...
final_weights, final_particles, final_timecourses1, final_timecourses2, pop_fold_res_path = central()
final_path_v = 'results_txt_files'+'/'+str(pop_fold_res_path)+'/Parameter_values_final.txt'
final_path_w = 'results_txt_files'+'/'+str(pop_fold_res_path)+'/Parameter_weights_final.txt'
