...
plot_posterior_distr <- function(results_path, pop_fold_res_path, limits, names){

  print(limits)
  print(names)
  p_values_final = read.table(paste(results_path,"/",pop_fold_res_path,"/Parameter_values_final.txt",sep=''))
  p_weights_final = read.table(paste(results_path,"/",pop_fold_res_path,"/Parameter_weights_final.txt",sep=''))
...
plot_posterior_distr(results_path, pop_fold_res_path, limits, names)